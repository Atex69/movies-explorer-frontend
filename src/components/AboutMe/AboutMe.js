            ...
            <div className="about-me__container">
                <div className="about-me__info">
                    ...
                    <p className="about-me__description">
                        Я&nbsp;родился в Уфе,&nbsp;живу в&nbsp;Санкт-Петербурге, закончил УГАТУ по специальности "Программная инженерия".Я&nbsp;люблю слушать музыку, а&nbsp;ещё увлекаюсь бегом. Недавно начал кодить. С&nbsp;2015 года
                    ...
                    <ul className="about-me__links">
                        <li><a className="about-me__link" href="https://github.com/atex69" target="_blank" rel="noreferrer">Github</a></li>
                    </ul>
                </div>
